...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 034a19bf-8b29-478a-8708-9185f0a50a66
```

> `034a19bf-8b29-478a-8708-9185f0a50a66` is the password of the certificate, you can change it to any password you want.
